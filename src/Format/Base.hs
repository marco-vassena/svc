...
(<*>) :: (Use a c m i xs, Use b c m i ys, Reify (a c m i), Reify (b c m i)) => a c m i xs -> b c m i ys -> Seq c m i (Append xs ys)
(<*>) = Seq
...
format :: Use a c m i xs => a c m i xs -> Format c m i xs
format = Format
