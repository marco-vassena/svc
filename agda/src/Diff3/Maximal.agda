...
maximal (DelCpy x d) = inj₁₂ (Id₂ (Del x) (Cpy x)) (maximal d)
maximal (CpyDel x d) = inj₁₂ (Id₁ (Cpy x) (Del x)) (maximal d)
maximal (CpyCpy x d) = inj₁₂ (Id₁ (Cpy x) (Cpy x)) (maximal d)
maximal (CpyUpd x y d) = inj₁₂ (Id₁ (Cpy x) (Upd x y)) (maximal d)
maximal (UpdCpy x y d) = inj₁₂ (Id₂ (Upd x y) (Cpy x)) (maximal d)
